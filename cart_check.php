        ...
        <form class="" id="form" name="form" method="post" action="https://www.sandbox.paypal.com/cgi-bin/webscr">
            <div class="membertext">
                ...
                <div class="memberbtn">
                    ...
                    <input type="hidden" name="amount_<?= $i; ?>" value="<?= $data['Product']['price']*0.031; ?>">
                    <?php $i++; } ?>
...
//        $('#custom').val(custom);
        ...
        if(isPass) {
            ...
            var custom = [email,password,name,address,phone];
            
            $.get('email_check.php', {email: email}, function(data){
                if(data!='1'){
                    $.get('user_session.php', {custom: custom}, function(data){
                        if(data=='1'){
